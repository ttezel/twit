...
Twitter.prototype = {
  get: function (path, params, callback) {
    this.request('GET', REST_ROOT + path, this.safeParams(params), false, callback);
  },
  post: function (path, params, callback) {
    this.request('POST', REST_ROOT + path, this.safeParams(params), false, callback);
  },
  stream: function (path, params) {
    ...
    return this.request('GET', ROOT + path, this.safeParams(params), true);
  },
