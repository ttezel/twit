...
Twitter.prototype = {
  ...
  setAuth: function (auth) {
    // update config
    this.config.consumer_key = auth.consumer_key || this.config.consumer_key
    this.config.consumer_secret = auth.consumer_secret || this.config.consumer_secret
    this.config.access_token = auth.access_token|| this.config.access_token
    this.config.access_token_secret = auth.access_token_secret|| this.config.access_token_secret
