      ...
      process.nextTick(function () {
        ...
        self._doRestApiRequest(reqOpts, twitOptions, method, function (err, parsedBody, resp) {
          ...
          if (callback && typeof callback === 'function') {
            ...
            // We don't have to give parsedBody, because if it's an API error err.allErrors
            // is already filled with them, if it's a json parse error, body is empty anyways.
            // err.twitterReply may already be set but we can just re-set it to make sure.
