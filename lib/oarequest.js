...
OARequest.prototype.makeRequest = function (cb) {
  ...
  var url_params = ''; // added by rodrigopolo.com in order to pass params on the request query
  ...
  // added by rodrigopolo.com in order to pass params on the request query
  ...
  return this.oauth.oa.post(
    ...
    , this.oauth.config.access_token
    , this.oauth.config.access_token_secret
    , url_params // modified by rodrigopolo.com in order to pass params on the request query
    , cb
  )
}
