...
OARequest.prototype.makeRequest = function (cb) {
  ...
  //  POST
// if params is a string, then first line is the content-type and remaining lines are the content...
  var contentType = 'application/x-www-form-urlencoded'
    , contentBody = this.params
    , x
    ;

  if ((typeof contentBody === 'string') && ((x = contentBody.indexOf('\r\n')) !== -1)) {
    contentType = contentBody.substr(0, x);
    contentBody = contentBody.substr(x + 2);
  }
