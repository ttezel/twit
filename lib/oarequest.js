  ...
  this.parser.on('element', function (msg) {
    ...
    if      (msg.delete)          { self.emit('delete', msg) }
      ...
      switch(msg.event) {
        ...
        case 'blocked': self.emit('user_blocked', msg) break
        case 'unblocked': self.emit('user_unblocked', msg) break
        case 'favorite': self.emit('user_favorite', msg) break
        case 'unfavorite': self.emit('user_unfavorite', msg) break
        case 'follow': self.emit('user_follow', msg) break
        case 'unfollow': self.emit('user_unfollow', msg) break
        case 'user_update': self.emit('user_user_update', msg) break
        case 'list_created': self.emit('user_list_created', msg) break
        case 'list_destroyed': self.emit('user_list_destroyed', msg) break
        case 'list_updated': self.emit('user_list_updated', msg) break
        case 'list_member_added': self.emit('user_list_member_added', msg) break
        case 'list_member_removed': self.emit('user_list_member_removed', msg) break
        case 'list_user_subscribed': self.emit('user_list_user_subscribed', msg) break
        case 'list_user_unsubscribed': self.emit('user_list_user_unsubscribed', msg) break
